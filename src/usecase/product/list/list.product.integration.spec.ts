...
describe("Teste list product use case", () => {
    ...
    it ("sould list a product", async () => {
        const productRepository = new ProductRepository();
        const usecase = new ListProductUseCase(productRepository);

        const product1 = new Product("123", "Product A", 11.22)
        const product2 = new Product("456", "Product B", 66.99);
